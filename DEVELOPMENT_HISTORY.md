...
> ⚠️ 最新路线图见 [PROJECT_PLAN.md](./PROJECT_PLAN.md)。以下为历史规划记录。

### v0.2.0 — Web UI MVP（✅ 已完成）
- [x] Web UI：上传/删除/预览知识库中的文档
- [x] 知识库统计：文档数量、覆盖主题、存储占用
- [x] Streamlit 多页面架构（摄入/检索/管理/配置）
